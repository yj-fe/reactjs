...
const AssetBox = ({ icon, text }) => (
  <div className="rounded-lg bg-gray-200 bg-opacity-10 p-4 h-20 flex flex-col items-center justify-center">
    {icon}
...
function MainPage() {
    const assetBoxData = [
    { icon: <FaSearch />, text: 'Send' },
    { icon: <FaBell />, text: 'Swap' },
    { icon: <FaUser />, text: 'Deposit' },
  ];
  return (
    <>
    {/* 내 자산 */}
      <div className="flex flex-col items-center lg:hidden">
        ...
        <div className="flex mt-4 w-full p-4 h-24">
