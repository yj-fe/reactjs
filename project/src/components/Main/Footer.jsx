...
function FooterIcon({ icon: Icon, text, isActive }) {
  return (
    <div className={`flex flex-col items-center ${isActive ? 'text-blue-500' : 'text-gray-600'}`}>
      <div
...
function Footer({ activeIcon }) {
  return (
    <div className='flex w-full bg-slate-100 text-gray-600 h-16 rounded-3xl justify-around items-center'>
